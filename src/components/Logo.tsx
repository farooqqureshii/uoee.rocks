...
const Logo: React.FC = () => {
  return (
    <div className="flex items-center space-x-4">
      {/* EE Logo */}
      <div className="p-3 bg-gradient-to-br from-blue-500 to-purple-600 rounded-none border-2 border-black shadow-brutal">
      ...
      <div>
        <h1 className="text-2xl font-black text-black">uoee.rocks</h1>
